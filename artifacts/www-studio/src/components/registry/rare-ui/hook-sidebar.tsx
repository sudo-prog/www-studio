...
// Stub for next/navigation — returns '' for pathname outside Next.js.
const usePathname = (): string => '';

// Stub for next/link — renders a plain anchor in non-Next environments.
const Link = ({ href, children, className, ...rest }: { href: string; children?: React.ReactNode; className?: string } & Record<string, unknown>) => (
...
export { HookSidebar as RareUIHookSidebar };
