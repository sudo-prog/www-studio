    ...
    <div className="animate-[fadeSlideIn_0.3s_ease-out] border border-red-500/30 bg-red-500/5 rounded-lg p-4 space-y-3">
      ...
      <div className="flex flex-wrap gap-2 pl-8">
        <Button
          ...
          variant="outline"
          onClick={onRetry}
          className="min-h-[48px] text-xs border-red-500/30 bg-transparent hover:bg-red-500/10 text-red-400"
        >
        ...
        {config.showUpload && (
          <Button
            ...
            className="min-h-[48px] text-xs border-[#27272a] bg-[#18181b] hover:bg-[#27272a]"
          >
