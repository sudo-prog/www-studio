...
export default function ScenePreviewPage() {
  ...
  return (
    <>
      ...
      <Link
        href="/"
        className="fixed top-[max(12px,env(safe-area-inset-top,0px))] left-3 z-50 flex flex-wrap items-center gap-1.5 px-3 min-h-[44px] min-w-[44px] rounded-full bg-background/80 backdrop-blur border border-border shadow-sm font-semibold text-sm tracking-tight hover:text-primary transition-colors"
      >
