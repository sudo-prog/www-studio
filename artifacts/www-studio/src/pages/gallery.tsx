    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm" onClick={onClose}>
      <div className="bg-card border border-border rounded-2xl p-6 w-full max-w-lg shadow-2xl" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex flex-wrap gap-2 mt-4">
          ...
          <Button size="sm" variant="outline" className="gap-1.5 min-h-[48px]" onClick={() => window.open(`/scenes/${scene.id}/preview`, "_blank")}>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-8">
        ...
        {published.length === 0 ? (
          <div className="text-center py-24 text-muted-foreground">
            ...
            <Button onClick={() => navigate("/scenes")} className="gap-2 min-h-[48px]">
